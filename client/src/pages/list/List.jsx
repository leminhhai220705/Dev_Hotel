...
//   const [destination, setDestination] = useState(location.state?.destination || ""); // Giá trị mặc định là chuỗi rỗng
...
//   const [min, setMin] = useState(undefined || { adult: 1, children: 0, room: 1 });
//   const [max, setMax] = useState(undefined || { adult: 1, children: 0, room: 1 });
